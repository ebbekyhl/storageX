...
def single_parametric_sweep(variable='E'):
    from scripts.read_simple_parametric import read_simple_parametric
    from scripts.plot_single_sweep import plot_single_sweep
