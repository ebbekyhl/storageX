...
def plot_existingtechs_result():
    ...
    ax.legend(list(leg.values()),['Electricity','+ Heating + Land Transport','Fully sector-coupled'],prop={'size':18})
    ...
    fig.savefig('figures/Existing_techs_output_' + output_dic[output] + '.png', dpi=300,
                 bbox_inches="tight")
