...
if sector == 0:
    fig_gen.legend(bbox_to_anchor=(0.95, 0),ncol=3,prop={'size':fs},frameon=True)
else:
    fig_gen.legend(bbox_to_anchor=(1.05, -0.05),ncol=3,prop={'size':fs},frameon=True)
...
# ax2.set_ylim([0,500])
if sector == 'T-H':
    ax1.legend(prop={'size':fs},ncol=1,bbox_to_anchor=(0.3,0.085))
else:
    ax1.legend(prop={'size':fs},ncol=1)
